      ...
      LegalSection(
        ...
        contents: [
          LegalContent.paragraph(
            '더글라스필름(이하 "사업자")는 모바일 앱 「하이진랩」(영문 표기 HygieneLab, 이하 "서비스") 제공을 위해 개인정보를 처리하며, 「개인정보 보호법」 등 관련 법령을 준수합니다.',
          ),
        ],
      ),
      LegalSection(
  ...
  return const LegalPage(
    ...
    sections: [
      LegalSection(
        ...
        contents: [
          LegalContent.paragraph(
            '본 약관은 더글라스필름(이하 "사업자")가 제공하는 모바일 앱 「하이진랩」(영문 표기 HygieneLab) 및 관련 웹페이지(이하 통칭 "서비스")의 이용과 관련하여 사업자와 회원 간 권리·의무 및 책임사항, 서비스 이용조건 및 절차를 규정함을 목적으로 합니다.',
          ),
        ],
      ),
      LegalSection(
  ...
  return const LegalPage(
    ...
    sections: [
      LegalSection(
        ...
        contents: [
          LegalContent.paragraph(
            '본 정책은 하이진랩(운영사: 더글라스필름)이 제공하는 A 클래스, B 클래스, C 클래스 등 채용공고 유료 노출 상품 및 이에 부수한 유료서비스에 적용됩니다.',
          ),
        ],
      ),
      LegalSection(
        heading: '2. 상품 및 가격 정보',
        contents: [
          LegalContent.subheading('A 클래스 (프리미엄) — 880,000원 / 기본 10일'),
          LegalContent.bullets([
            '전국 모든 유저 대상 채용 개시 알림 발송',
            '앱 내 광고 영역 최상단 우선 배치, 스크롤 중 반복 노출',
            '지도 강조 노출, 매칭 추천 최고 우선순위',
            '전체 공고에서 사진 포함 노출',
          ]),
          LegalContent.subheading('B 클래스 (추천) — 440,000원 / 기본 10일'),
          LegalContent.bullets([
            '해당 시·도 유저 대상 채용 개시 알림 발송',
            '광고 및 추천 영역 우선 노출',
            '전체 공고에서 사진 포함 노출',
          ]),
          LegalContent.subheading('C 클래스 (일반) — 110,000원 / 기본 10일'),
          LegalContent.bullets([
            '전체 공고 목록 기본 노출',
            '지도 기본 노출',
          ]),
      ...
      LegalSection(
        ...
        contents: [
          LegalContent.bullets([
            '회원이 결제를 완료하고 공고가 게시(노출)되면 서비스 이용이 개시된 것으로 봅니다.',
            '「전자상거래 등에서의 소비자보호에 관한 법률」 제17조 제2항 제5호에 따라, 노출이 개시된 디지털 광고·노출 서비스는 청약철회 대상에서 제외될 수 있습니다.',
          ]),
        ],
      ),
      LegalSection(
        heading: '4. 환불 및 청약철회 가능한 경우',
        contents: [
          LegalContent.bullets([
            '공고가 실제 게시되기 전까지는 전액 환불을 요청할 수 있습니다.',
            '회사의 자격 확인 불가 또는 운영정책 사유로 공고 게시가 승인되지 않은 경우 전액 환불합니다.',
            '시스템 오류, 결제대행사 장애, 기술적 결함으로 정상 서비스가 제공되지 않은 경우 환불합니다.',
            '중복결제 또는 오결제가 확인되는 경우, 실제 사용되지 않은 결제 건에 한하여 환불합니다.',
          ]),
        ],
      ),
      LegalSection(
        heading: '5. 환불이 제한되거나 불가한 경우',
        contents: [
          LegalContent.bullets([
            '공고가 게시되어 노출이 시작된 이후에는 원칙적으로 환불이 불가합니다.',
            '허위·과장·불법 정보를 고의로 등록한 경우',
            '부적격 자격자료 또는 허위 사업자정보를 의도적으로 제출한 경우',
            '회원의 귀책사유로 인하여 공고가 중단되거나 삭제된 경우',
          ]),
        ],
      ),
      LegalSection(
        heading: '6. 중복결제 및 오결제 처리',
        contents: [
          LegalContent.bullets([
            '동일 회원 또는 동일 공고에 중복 결제가 발생한 경우, 실제 사용되지 않은 결제 건에 한하여 확인 후 환불합니다.',
            '시스템 오류로 인한 중복결제는 확인 후 지체 없이 환불 절차를 진행합니다.',
            '중복결제·오결제 환불 요청은 결제일로부터 7일 이내 고객센터를 통해 접수해야 합니다.',
          ]),
        ],
      ),
      LegalSection(
        heading: '7. 환불 신청 방법 및 처리 기간',
        contents: [
          LegalContent.bullets([
            '환불 요청은 고객센터 이메일(chikabooks.app@gmail.com)로 주문정보와 사유를 제출하여 접수할 수 있습니다.',
            '환불이 승인된 경우 관련 법령 및 결제수단별 정책에 따라 지체 없이 환불을 진행합니다.',
            '실제 환불 완료 시점은 카드사, 은행, 간편결제 사업자, 결제대행사(토스페이먼츠) 정책에 따라 달라질 수 있습니다.',
          ]),
        ],
      ),
      LegalSection(
