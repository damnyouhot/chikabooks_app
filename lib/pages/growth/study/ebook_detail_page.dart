...
import 'epub_reader_page.dart'; // 새 뷰어 페이지

class EbookDetailPage extends StatelessWidget {
  final Ebook ebook;
  const EbookDetailPage({Key? key, required this.ebook}) : super(key: key);
          ...
          children: [
            ...
            Center(
              child: ElevatedButton(
                ...
                child: Text(
                  ebook.price == 0 ? '무료로 보기' : '${ebook.price}원 구매',
                ),
              ),
            ),
          ],
